function [selectedImg R P AP] = VS_M(queryName, distMeasure, PCA)

%% This function will use the database images moment descriptors and the specified distance measure to rank the database images according to their similarity to the specified query image.
...
load(featFileQuery, 'F_M');
featFileQueryData=F_M;
...
for i=1:NIMG  
    ...
    elseif(distMeasure == 'C')
       % Compute Canberra distance to the query
