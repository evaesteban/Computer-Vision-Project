function [selectedImg R P AP] = VS_NEW(queryName, distMeasure, PCA)

%% This function will use the new technique image descriptors together with the specified distance measure to rank the database images according to the similarity to the specified query image.
...
load(featFileQuery, 'F_NEW');
featFileQueryData=F_NEW;
