function [selectedImg R P AP] = VS_CG(queryName, distMeasure, PCA)

%% This function will use the pre-computed colour grid descriptors with the specified distance measure to rank the database images according to the similarity to the specified query image.
...
load(featFileQuery, 'F_CG');
featFileQueryData=F_CG;
...
if(PCA == true)
    ...
    sumE = sumE*0.91; % Percentage of eigenvalues
    sumEImg = 0;
