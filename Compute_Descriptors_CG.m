function Compute_Descriptors_CG(x,y)

%% This function will compute the colour grid descriptors with the specified grid size for all the images within the
